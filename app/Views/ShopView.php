...
<body class="toolbar-enabled">
    <!-- Sign in / sign up modal here-->
    
    <!-- Navbar-->
    <!-- Quick View Modal here-->
        ...
        <div class="navbar navbar-expand-lg navbar-dark">
            <div class="container"><a class="navbar-brand d-none d-sm-block mr-4 order-lg-1" href="index.html" style="min-width: 7rem;"><img width="142" src="img/logo-light.png" alt="Cartzilla" /></a><a class="navbar-brand d-sm-none mr-2 order-lg-1" href="index.html" style="min-width: 4.625rem;"><img width="74" src="img/logo-icon-light.png" alt="Cartzilla" /></a>
                <div class="navbar-toolbar d-flex align-items-center order-lg-3">
                    ...
                    </a><a class="navbar-tool ml-1 mr-n1" href="#signin-modal" data-toggle="modal"><span class="navbar-tool-tooltip">Account</span>
                        <div class="navbar-tool-icon-box"><i class="navbar-tool-icon czi-user"></i></div>
                    </a>
                    <a class="navbar-tool ml-1 mr-n1" href="order-tracking.html"><span class="navbar-tool-tooltip">Tracking</span>
                        <div class="navbar-tool-icon-box"><i class="navbar-tool-icon czi-location"></i></div>
                    </a>
                    
                    <div class="navbar-tool dropdown ml-3"><a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="shop-cart.html"><span class="navbar-tool-label">4</span><i class="navbar-tool-icon czi-cart"></i></a>
                        <!-- Cart dropdown-->
                ...
                <div class="collapse navbar-collapse mr-auto order-lg-2" id="navbarCollapse">
                    ...
                    <!-- Primary menu-->
                    <ul class="navbar-nav">
                        <li ><a class="nav-link" href="home-fashion-store-v1.html">Home</li></a>
    ...
    <div class="container pb-5 mb-2 mb-md-4">
        ...
        <footer class="bg-darker pt-5">
            ...
            <div class="container">
                ...
                <div class="pb-4 font-size-xs text-light opacity-50 text-center text-md-left">© All rights reserved. Front-end template made by <a class="text-light" href="https://createx.studio/" target="_blank" rel="noopener">Createx Studio</a></div>
            </div>
