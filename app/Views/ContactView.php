        ...
        <div class="container"><a class="navbar-brand d-none d-sm-block mr-4 order-lg-1" href="home" style="min-width: 7rem;"><img width="142" src="img/logo-light.png" alt="JetreneEshop" /></a><a class="navbar-brand d-sm-none mr-2 order-lg-1" href="home" style="min-width: 4.625rem;"><img width="74" src="img/logo-icon-light.png" alt="JetreneEshop" /></a>
                ...
                <div class="collapse navbar-collapse mr-auto order-lg-2" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link active" href="contacts">Contacts</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid px-0" id="map">
        <div class="row no-gutters">
            <div class="col-lg-6 iframe-full-height-wrap">
                <iframe class="iframe-full-height" width="600" height="250" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=San Vicente east Calapan City&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"  allowfullscreen="true" aria-hidden="false" tabindex="0"></iframe>
            </div>
