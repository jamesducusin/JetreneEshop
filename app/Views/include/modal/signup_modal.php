        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
                    <?php $register = session()->getFlashdata('validatereg'); ?>
                    ...
                    <li class="nav-item"><a class="nav-link" id="otp" href="#otp-tab" data-toggle="tab" role="tab" aria-selected="true"><i class="czi-unlocked mr-2 mt-n1"></i>Otp</a></li>
                </ul>
                ...
                <?php if (isset($validation) && !isset($register) || !empty(session()->getFlashdata('validation'))) : ?>
                    ...
                    <?php else : ?>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" placeholder="j****@example.com" name="email" required>
                        ...
                        <?php if (isset($validation) && isset($register)) : ?>
                            ...
                            <?php else : ?>
                                ...
                                <form action="<?= base_url() ?>otpverify" method="post" class="needs-validation tab-pane fade" novalidate autocomplete="off" id="otp-tab">
                                <div class="mt-1 text-center">
                                        <h3 class="mb-0"> Enter OTP  </h3>
                                    </div>
                                    <div class="mb-3 text-center">
                                        <p class="mb-0"> (<?="james2gmail.com"?>)</p>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            <div class="mb-2  ">
                                                ...
                                                <input type="text" class="form-control form-control-lg bg-light border-dark text-center" name="otp[]" onkeyup="moveToNext(1, event)" maxLength="1" id="digit1-input">
                                            </div>
                                        </div><!-- end col -->
                                        ...
                                        <div class="col-2">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" class="form-control form-control-lg bg-light border-dark text-center" name="otp[]" onkeyup="moveToNext(2, event)" maxLength="1" id="digit2-input">
                                            </div>
                                        </div><!-- end col -->
                                        ...
                                        <div class="col-2">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" class="form-control form-control-lg bg-light border-dark text-center" name="otp[]" onkeyup="moveToNext(3, event)" maxLength="1" id="digit3-input">
                                            </div>
                                        </div><!-- end col -->
                                        ...
                                        <div class="col-2">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" class="form-control form-control-lg bg-light border-dark text-center" name="otp[]" onkeyup="moveToNext(4, event)" maxLength="1" id="digit4-input">
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-2">
                                            <div class="mb-2">

                                                <input type="text" class="form-control form-control-lg bg-light border-dark text-center" name="otp[]" onkeyup="moveToNext(5, event)" maxLength="1" id="digit5-input">
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-2">
                                            <div class="mb-2">

                                                <input type="text" class="form-control form-control-lg bg-light border-dark text-center" name="otp[]" onkeyup="moveToNext(6, event)" maxLength="1" id="digit6-input">
                                            </div>
                                        </div><!-- end col -->
                                    </div>
                                    <div class="mt-3">
