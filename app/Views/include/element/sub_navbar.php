<div class="navbar-toolbar d-flex align-items-center order-lg-3">
    ...
    <?php if (!session()->get('login')) : ?>
        ...
        <?php endif; ?>
        <?php if (session()->get('login')) : ?>
            <a class="navbar-tool ml-1 mr-n1" href="logout"><span class="navbar-tool-tooltip">Logout</span>
                ...
                <div class="dropdown-menu dropdown-menu-right" style="width: 20rem;">
                    <div class="widget widget-cart px-3 pt-2 pb-3">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                            <div class="font-size-sm mr-2 py-2"><span class="text-muted">Subtotal:</span><span class="text-accent font-size-base ml-1">$265.<small>00</small></span></div><a class="btn btn-outline-secondary btn-sm" href="cart">Expand cart<i class="czi-arrow-right ml-1 mr-n1"></i></a>
